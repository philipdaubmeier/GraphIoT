...
namespace PhilipDaubmeier.DigitalstromHost.Polling
{
    public class DigitalstromEnergyPollingService : IDigitalstromPollingService
    {
        ...
        public DigitalstromEnergyPollingService(ILogger<DigitalstromEnergyPollingService> logger, IDigitalstromDbContext databaseContext, DigitalstromDssClient dsClient)
        {
            _logger = logger;
